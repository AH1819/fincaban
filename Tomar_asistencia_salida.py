...
class AsistenciaSalida:
    def __init__(self, panel):
        ...
        self.confirma = Button(self.frame_options, text="Confirmar Salida", font=("Helvetica", 10),
    ...
    def registrar_asistencia(self):
        ...
        if ast.validar_existencia_registro(self.UserName):  # Válida existencia
            if ast.validar_registro_salida(self.UserName):  # Válida sí hay alguna entrada
                if ast.registrar_asistencia_salida(self.UserName):  # Registra la entrada
